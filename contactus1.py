            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <div class="contact-form">
                  <div class="row">
                    """ + (name_data and "<div class='col-lg-12'><p style='font-family: Arial, sans-serif; font-size: 16px;'>Full Name: " + name_data + "</p></div>") + """
                    """ + (email_data and "<div class='col-lg-12'><p style='font-family: Arial, sans-serif; font-size: 16px;'>Email: " + email_data + "</p></div>") + """
                    """ + (message_data and "<div class='col-lg-12'><p style='font-family: Arial, sans-serif; font-size: 16px;'>Message: " + message_data + "</p></div>") + """
                  </div>
                </div>
            </div>
          </div>
